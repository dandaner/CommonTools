package com.demon.commontools.net;
...
public class NetworkUtil {
    ...
    private static ConnectivityManager getConnectivityManager(Context cxt) {
        if (sCM == null) {
            sCM = (ConnectivityManager) cxt.getSystemService(Context.CONNECTIVITY_SERVICE);
        }
        return sCM;
    }
    ...
    public static boolean isNetworkAvaialble(Context ctx) {
        ...
        try {
            ...
            LogUtils.w(TAG, "failed to get active networkinfo: " + e);
        }
    ...
    public static int getNetworkType(Context cxt) {
        ...
        if (netInfo != null) {
            ...
            LogUtils.d(TAG, "network type = " + type + " : " + subType);
